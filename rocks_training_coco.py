...
dataset_train.load_data('./datasets/rocks-test3-augmented/train/_annotations.coco.json', 
                        './datasets/rocks-test3-augmented/train/')
dataset_train.prepare()
print('Train: %d' % len(dataset_train.image_ids))

#In this example, I do not have annotations for my validation data, so I am loading train data
dataset_val = CocoLikeDataset()
dataset_val.load_data('./datasets/rocks-test3-augmented/valid/_annotations.coco.json',
                      './datasets/rocks-test3-augmented/valid/')
dataset_val.prepare()
...
COCO_WEIGHTS_PATH = os.path.join(ROOT_DIR, "./models/rocks_mrcnn_public_dataset_25ep.h5")
